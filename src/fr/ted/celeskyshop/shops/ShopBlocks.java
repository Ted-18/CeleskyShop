...
public class ShopBlocks implements Listener {
	...
	public static void shopItemBlocks(Main main, Player player) {
		...
		//Permission level 2
		String shopLevel2 = main.getConfig().getString("sellers.blocks.shopLevel2");
		...
		//Permission level 3
		String shopLevel3 = main.getConfig().getString("sellers.blocks.shopLevel3");
		...
		//Permission level 4
		String shopLevel4 = main.getConfig().getString("sellers.blocks.shopLevel4");
		...
		//Permission level 5
		String shopLevel5 = main.getConfig().getString("sellers.blocks.shopLevel5");
