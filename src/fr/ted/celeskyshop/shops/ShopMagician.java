...
public class ShopMagician {

	public static void shopItemMagician(Main main, Player player) {

		//Get Shop name from config
		String shopName = main.getConfig().getString("sellers.Magician.shopName");
		...
		//Permission level 1
		String shopLevel1 = main.getConfig().getString("sellers.Magician.shopLevel1");
		...
		//Permission level 2
		String shopLevel2 = main.getConfig().getString("sellers.Magician.shopLevel2");
		...
		//Permission level 3
		String shopLevel3 = main.getConfig().getString("sellers.Magician.shopLevel3");
		...
		//Permission level 4
		String shopLevel4 = main.getConfig().getString("sellers.Magician.shopLevel4");
		...
		//Permission level 5
		String shopLevel5 = main.getConfig().getString("sellers.Magician.shopLevel5");
