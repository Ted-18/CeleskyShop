...
public class ShopButcher {

	public static void shopItemButcher(Main main, Player player) {

		//Get Shop name from config
		String shopName = main.getConfig().getString("sellers.Butcher.shopName");
		...
		//Permission level 1
		String shopLevel1 = main.getConfig().getString("sellers.Butcher.shopLevel1");
		if(player.hasPermission(shopLevel1) == true) {
			...
			shopItem.setItem(1, ShopItem.addItemShop(Material.MUTTON, 1, null, null, 2, 1));
			shopItem.setItem(2, ShopItem.addItemShop(Material.BEEF, 1, null, null, 2, 1));
			shopItem.setItem(3, ShopItem.addItemShop(Material.PORKCHOP, 1, null, null, 2, 1));
			shopItem.setItem(4, ShopItem.addItemShop(Material.CHICKEN, 1, null, null, 2, 1));
			shopItem.setItem(5, ShopItem.addItemShop(Material.RABBIT, 1, null, null, 2, 1));
			shopItem.setItem(6, ShopItem.addItemShop(Material.COD, 1, null, null, 2, 1));
			shopItem.setItem(7, ShopItem.addItemShop(Material.SALMON, 1, null, null, 2, 1));
		}
		else {
		...
		//Permission level 2
		String shopLevel2 = main.getConfig().getString("sellers.Butcher.shopLevel2");
		if(player.hasPermission(shopLevel2) == true) {
			...
			shopItem.setItem(10, ShopItem.addItemShop(Material.COOKED_MUTTON, 1, null, null, 2, 1));
			shopItem.setItem(11, ShopItem.addItemShop(Material.COOKED_BEEF, 1, null, null, 2, 1));
			shopItem.setItem(12, ShopItem.addItemShop(Material.COOKED_PORKCHOP, 1	, null, null, 2, 1));
			shopItem.setItem(13, ShopItem.addItemShop(Material.COOKED_CHICKEN, 1, null, null, 2, 1));
			shopItem.setItem(14, ShopItem.addItemShop(Material.COOKED_RABBIT, 1, null, null, 2, 1));
			shopItem.setItem(15, ShopItem.addItemShop(Material.COOKED_COD, 1, null, null, 2, 1));
			shopItem.setItem(16, ShopItem.addItemShop(Material.COOKED_SALMON, 1, null, null, 2, 1));
		}
		else {
		...
		//Permission level 3
		String shopLevel3 = main.getConfig().getString("sellers.Butcher.shopLevel3");
		if(player.hasPermission(shopLevel3) == true) {
			...
			shopItem.setItem(19, ShopItem.addItemShop(Material.RABBIT_STEW, 1, null, null, 2, 1));
		}
		else {
		...
		//Permission level 4
		String shopLevel4 = main.getConfig().getString("sellers.Butcher.shopLevel4");
		...
		//Permission level 5
		String shopLevel5 = main.getConfig().getString("sellers.Butcher.shopLevel5");
		if(player.hasPermission(shopLevel5) == true) {
			...
			shopItem.setItem(37, ShopItem.addItemShop(Material.NAME_TAG, 1, null, null, 2, 1));
			shopItem.setItem(38, ShopItem.addItemShop(Material.LEAD, 1, null, null, 2, 1));
		}
		else {
