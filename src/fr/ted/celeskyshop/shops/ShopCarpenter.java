...
public class ShopCarpenter {

    public static void shopItemCarpenter(Main main, Player player) {
    	
		//Get Shop name from config
		String shopName = main.getConfig().getString("sellers.Carpenter.shopName");
		...
		//Permission level 1
		String shopLevel1 = main.getConfig().getString("sellers.Carpenter.shopLevel1");
		if(player.hasPermission(shopLevel1) == true) {
			...
			shopItem.setItem(1, ShopItem.addItemShop(Material.OAK_LOG, 1, null, null, 2, 1));
			shopItem.setItem(2, ShopItem.addItemShop(Material.OAK_SAPLING, 1, null, null, 2, 1));
			shopItem.setItem(3, ShopItem.addItemShop(Material.BIRCH_LOG, 1	, null, null, 2, 1));
			shopItem.setItem(4, ShopItem.addItemShop(Material.BIRCH_SAPLING, 1	, null, null, 2, 1));
		}
		else {
		...
		//Permission level 2
		String shopLevel2 = main.getConfig().getString("sellers.Carpenter.shopLevel2");
		if(player.hasPermission(shopLevel2) == true) {
			...
			shopItem.setItem(10, ShopItem.addItemShop(Material.DARK_OAK_LOG, 1, null, null, 2, 1));
			shopItem.setItem(11, ShopItem.addItemShop(Material.DARK_OAK_SAPLING, 1, null, null, 2, 1));
			shopItem.setItem(12, ShopItem.addItemShop(Material.SPRUCE_LOG, 1, null, null, 2, 1));
			shopItem.setItem(13, ShopItem.addItemShop(Material.SPRUCE_SAPLING, 1, null, null, 2, 1));
		}
		else {
		...
		//Permission level 3
		String shopLevel3 = main.getConfig().getString("sellers.Carpenter.shopLevel3");
		if(player.hasPermission(shopLevel3) == true) {
			...
			shopItem.setItem(19, ShopItem.addItemShop(Material.JUNGLE_LOG, 1, null, null, 2, 1));
			shopItem.setItem(20, ShopItem.addItemShop(Material.JUNGLE_SAPLING, 1, null, null, 2, 1));
			shopItem.setItem(21, ShopItem.addItemShop(Material.ACACIA_LOG, 1, null, null, 2, 1));
			shopItem.setItem(22, ShopItem.addItemShop(Material.ACACIA_SAPLING, 1, null, null, 2, 1));
		}
		else {
		...
		//Permission level 4
		String shopLevel4 = main.getConfig().getString("sellers.Carpenter.shopLevel4");
		if(player.hasPermission(shopLevel4) == true) {
			...
			shopItem.setItem(28, ShopItem.addItemShop(Material.MANGROVE_LOG, 1, null, null, 2, 1));
			shopItem.setItem(29, ShopItem.addItemShop(Material.MANGROVE_PROPAGULE, 1, null, null, 2, 1));
			shopItem.setItem(30, ShopItem.addItemShop(Material.MANGROVE_ROOTS, 1, null, null, 2, 1));
			shopItem.setItem(31, ShopItem.addItemShop(Material.BAMBOO, 1, null, null, 2, 1));
		}
		else {
		...
		//Permission level 5
		String shopLevel5 = main.getConfig().getString("sellers.Carpenter.shopLevel5");
		if(player.hasPermission(shopLevel5) == true) {
			...
			shopItem.setItem(37, ShopItem.addItemShop(Material.WARPED_STEM, 1, null, null, 2, 1));
			shopItem.setItem(38, ShopItem.addItemShop(Material.WARPED_FUNGUS, 1, null, null, 2, 1));
			shopItem.setItem(39, ShopItem.addItemShop(Material.TWISTING_VINES, 1, null, null, 2, 1));
			shopItem.setItem(40, ShopItem.addItemShop(Material.CRIMSON_STEM, 1, null, null, 2, 1));
			shopItem.setItem(41, ShopItem.addItemShop(Material.CRIMSON_FUNGUS, 1, null, null, 2, 1));
			shopItem.setItem(42, ShopItem.addItemShop(Material.WEEPING_VINES, 1, null, null, 2, 1));
		}
		else {
